            ...
            <TABLE width=460 border=0>
              ...
              <TR>
                <TD width=260 rowSpan=2><IMG height=20 alt="" 
                  src="Your BestBuy_com Shopping Cart_files/spacer.gif" width=1 
                  border=0><BR>
                  
                  <html:img height="35" alt="Shopping Cart" page="/order/images/cart.gif"  border="0"/>
                  <IMG height=6 alt="" src="Your BestBuy_com Shopping Cart_files/spacer.gif" width=1 
                  border=0><BR></TD>
            ...
            <TABLE cellSpacing=0 cellPadding=3 width=460 border=0>             
              ...
              <TR bgColor=#ffffff>
                ...
                <TD vAlign=top align=left><FONT 
                  ...
                  <html:link page="/action/viewitemdetail?id=1">
              ...
              <TR>
                <TD colSpan=5>
                  ...
                  bgColor=#cccccc>
                    <TBODY>
                    <TR>
                      <TD><IMG height=1 alt="" src="Your BestBuy_com Shopping Cart_files/spacer.gif" width=1 border=0></TD></TR></TBODY></TABLE></TD>
                    </TR>
                <!-- /Grey Separator Row -->
                  ...
                  bgColor=#c0c0c0 border=1>
                    ...
                    <TR>
                      ...
                      <TD align=left width=131><IMG height=1 alt="" 
                        src="Your BestBuy_com Shopping Cart_files/spacer.gif" 
            ...
            <TABLE cellSpacing=0 cellPadding=0 width="100%">
              ...
              <TR>
                <TD bgColor=#cccccc><IMG height=1 alt="" 
                  ...
                  border=0></TD>
                <TD><IMG height=1 alt="" 
                  src="Your BestBuy_com Shopping Cart_files/spacer.gif" width=5 
                  border=0></TD>
                <TD bgColor=#cccccc><IMG height=1 alt="" 
                  src="Your BestBuy_com Shopping Cart_files/spacer.gif" width=1 
                  border=0></TD>
